...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      <aside className="w-64 sm:w-72 shrink-0 h-screen sticky top-0 bg-zinc-50 dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800/80 flex flex-col justify-between select-none z-30">
        ...
        <div className="p-3 border-t border-zinc-200 dark:border-zinc-800/80 bg-zinc-100/60 dark:bg-zinc-900/40 flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">
          ...
          >
            ...
            <span className="text-[11px] font-medium hidden sm:inline text-zinc-600 dark:text-zinc-400">GitHub</span>
          </a>
